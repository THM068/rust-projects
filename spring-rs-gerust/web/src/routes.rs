...
use crate::controllers::registration_controller::registration_routes;
use std::sync::Arc;
use crate::controllers::home_controller::home_routes;
...
pub fn init_routes(app_state: AppState) -> Router {
    ...
    Router::new()
        ...
        .nest("/api", registration_routes(Arc::clone(&shared_app_state)))
}
